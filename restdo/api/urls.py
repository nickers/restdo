...
urlpatterns = patterns('',
   ...
   url(r'^books$', books_list_handler, { 'emitter_format': 'json'}),
   ...
   url(r'^lends$', book_lends_list_handler, { 'emitter_format': 'json'}),
   ...
   url(r'^readers$', readers_list_handler, { 'emitter_format': 'json'}),
